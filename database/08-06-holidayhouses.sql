CREATE DATABASE  IF NOT EXISTS `holidayhouses` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `holidayhouses`;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `holidayhouses`.`houses_BEFORE_DELETE` BEFORE DELETE ON `houses` FOR EACH ROW
BEGIN
	DELETE FROM bookings WHERE houses_id = old.id;
	DELETE FROM houses_images WHERE houses_id = old.id;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `holidayhouses`.`users_BEFORE_DELETE` BEFORE DELETE ON `users` FOR EACH ROW
BEGIN
		DELETE FROM bookings WHERE bookings.users_id = old.id;
        DELETE FROM houses WHERE houses.users_id = old.id;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-06-08 13:23:23
